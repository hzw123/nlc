...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#tab-sever').bootstrapTable({
        	url: '/api/servers',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    oTableInit.queryParams = function (params) {
        ...
        return {"name":temp.name,"size":temp.size,"page":temp.page,"ip":temp.ip,"status":temp.status};
    };
    return oTableInit;
};
  ...
  return oInit;
    ...
    function operateFormatter(value, row, index) {
            return [
                ...
                '<button type="button" class="RoleOfB btn btn-default  btn-sm" style="margin-right:15px;">增减空闲线程</button>',
