...
var ButtonInit = function () {
  ...
  return oInit;
    ...
    function operateFormatter(value, row, index) {
            return [
                '<button type="button" class="RoleOfA btn btn-default  btn-sm" style="margin-right:15px;">导出</button>',
                ...
                '<button type="button" class="RoleOfSee btn btn-default  btn-sm" style="margin-right:15px;">创建任务</button>'
            ].join('');
        }
